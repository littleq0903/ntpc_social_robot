...
python lib/app.py reset-fail -t mediumIncome 中低收

echo 上傳「中低收入老人」案件⋯⋯
python lib/app.py reset-fail 中低老人
python lib/app.py reset-fail -t mediumIncomeOld 中低老人

echo 上傳「身障」案件⋯⋯
python lib/app.py reset-fail 身障
python lib/app.py reset-fail -t disability 身障

echo 上傳「兒少」案件⋯⋯
python lib/app.py reset-fail 兒少
python lib/app.py reset-fail -t poorKid 兒少
